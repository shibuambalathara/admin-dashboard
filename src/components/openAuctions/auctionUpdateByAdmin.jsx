  ...
  {liveItem?.event?.status!=='pause' ?  < div className="w-full ">
      {liveItem  ? (
        <div className="py-10 mx-10 ">
          ...
          <div className="mt-8 mx-auto flex flex-col justify-center w-full ">
            ...
            {/* Vehicles Details */}
              {/* <div className="text-lg font-semibold w-full bg-zinc-400">Vehicle Details</div> */}
            <section className="space-y-2 flex w-full ">
            <section className=" space-y-2  bg-green-100  ">
              ...
              <div className=" max-w-md px-2 py-1 rounded sm:px-0">
                <Tab.Group>
